...
from capa_datos_persona.curso_del_pool import CursorDelPool
...
class UsuarioDAO:
    ...
    _INSERTAR = 'INSERT INTO usuario(username, password) VALEU (%s, %s)'
...
if __name__ == '__main__':
    ...
    usuario_modificado = UsuarioDAO.actualizar(usaurio)
